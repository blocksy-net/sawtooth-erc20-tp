...
public class SawtoothHelper {
     ...
     */
    public static void setState(Context state, Collection<Map.Entry<String, ByteString>> addressValues) throws ReadWriteStateException {
        try {
            ...
            //addresses.forEach(adr -> logger.info("Address=" + adr));
     ...
     * @throws ReadWriteStateException
     */
    public static Map<String, ByteString> getState(Context state, Collection<String> addresses) throws ReadWriteStateException {
        try {
